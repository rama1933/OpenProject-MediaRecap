...
class VideoController extends Controller
{
    ...
    {
        $tahun = date('Y');
        $data['jan'] = video::where('status', 0)->whereYear('tanggal', $tahun)->whereMonth('tanggal', '01')->count();
        $data['feb'] = video::where('status', 0)->whereYear('tanggal', $tahun)->whereMonth('tanggal', '02')->count();
        $data['mar'] = video::where('status', 0)->whereYear('tanggal', $tahun)->whereMonth('tanggal', '03')->count();
        $data['apr'] = video::where('status', 0)->whereYear('tanggal', $tahun)->whereMonth('tanggal', '04')->count();
        $data['mei'] = video::where('status', 0)->whereYear('tanggal', $tahun)->whereMonth('tanggal', '05')->count();
        $data['jun'] = video::where('status', 0)->whereYear('tanggal', $tahun)->whereMonth('tanggal', '06')->count();
        $data['jul'] = video::where('status', 0)->whereYear('tanggal', $tahun)->whereMonth('tanggal', '07')->count();
        $data['agt'] = video::where('status', 0)->whereYear('tanggal', $tahun)->whereMonth('tanggal', '08')->count();
        $data['sep'] = video::where('status', 0)->whereYear('tanggal', $tahun)->whereMonth('tanggal', '09')->count();
        $data['okt'] = video::where('status', 0)->whereYear('tanggal', $tahun)->whereMonth('tanggal', '10')->count();
        $data['nop'] = video::where('status', 0)->whereYear('tanggal', $tahun)->whereMonth('tanggal', '11')->count();
        $data['des'] = video::where('status', 0)->whereYear('tanggal', $tahun)->whereMonth('tanggal', '12')->count();
        return view('video.chart', $data);
    }
    ...
    public function pdf(Request $request)
    {
        ...
        $data['video'] = Video::where('status', 0)->get();

        $pdf = PDF::loadview('video/pdf', $data);
    ...
    public function pdf_filter(Request $request)
    {
        ...
        $query = Video::select('tbl_master_arsip_video.*')->where('status', 0);
