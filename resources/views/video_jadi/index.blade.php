...
<section class="content">
            ...
            <div class="col-md-12">
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="card mb-5">
                                    <div class="card-header">
                                        <h3 class="card-title">Arsip Video jadi</h3>
                                    </div>
                                    <!-- /.card-header -->
                                    <div class="card-body">
                                        <button class="btn btn-primary mb-5" data-toggle="modal"
                                            data-target="#modal-tambah">Tambah</button>
                                        <a href="{{ url('') }}/video_jadi_chart" class="btn btn-danger mb-5"><i
                                                class="fa fa-chart"> Grafik</i></a>
                                        <a href="{{ url('') }}/video_jadi_pdf" title="Unduh Dokumen (PDF)"
                                        ...
                                        <div id="cetak_filter_bulan" class="mb-4" style="display: none">
                                            <form action="{{ url('') }}/video_jadi_pdf_filter_bulan"
                                                class="form-inline">
                                        ...
                                        <div id="cetak_filter" class="mb-4" style="display: none">
                                            <form action="{{ url('') }}/video_jadi_pdf_filter" class="form-inline">
                                                <div class="form-group mr-2">
                ...
                <div class="modal fade" id="modal-edit">
                    <div class="modal-dialog modal-lg">
                        <form method="post" id="form-edit" action="{{ url('/video_jadi_update') }}"
    ...
    <div class="modal fade" id="modal-tambah">
        <div class="modal-dialog modal-lg">
            <form method="post" id="form-tambah" action="{{ url('/video_jadi_store') }}" enctype="multipart/form-data">
                @csrf
                <div class="modal-content">
                    <div class="modal-header" style="background-color: cornflowerblue">
